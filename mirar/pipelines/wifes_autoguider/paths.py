...
PSFMODEL_X_STD_KEY = 'PSF_X_STD'
PSFMODEL_Y_STD_KEY = 'PSF_Y_STD'
PSFMODEL_AMP_KEY = 'PSF_AMP'
PSFMODEL_GFIT_KEY = 'PSF_GFIT'
PSFMODEL_X_POS_KEY = 'PSF_X_POS'
PSFMODEL_Y_POS_KEY = 'PSF_Y_POS'
PSFMODEL_STATUS_KEY = 'PSF_FIT_STATUS'
